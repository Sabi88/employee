...
public class EmployeeRepositoryTest {
	...
	void setUp() {
		...
		emp1 = new Employee(1L, 1L, 1L,"Shannon", 30, "Test");
		emp2= new Employee(2L, 2L, 2L,"Shannon", 30, "Test");
		emp3 = new Employee(3L, 3L, 3L,"Shannon", 30, "Test");
		emp4= new Employee(4L, 4L, 4L,"Shannon", 30, "Test");
		empList.add(emp1);
		empList.add(emp2);
		empList.add(emp3);
		empList.add(emp4);
